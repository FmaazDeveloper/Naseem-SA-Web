                            ...
                            <tbody>
                                @foreach ($permissions as $permission)
                                        <tr>
                                            ...
                                            <td>
                                                <small>
                                                    <span>{{ 'Created : ' . $permission->created_at }} | {{ 'Updated : ' . $permission->updated_at }}</span>
                                                </small>
                                            </td>
                                            <td>
                                                ...
                                                <form style="display: inline" method="post" action="{{ route('permissions.destroy', $permission->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
