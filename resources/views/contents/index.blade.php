    ...
    <div style="background-image: url(images/pages/main_page.jpg); background-size: cover; ">
        <div class="container p-3">
            <div class="row text-center">
                {{-- <div class="col"> --}}
                <div class="font-sans antialiased dark:bg-black dark:text-white/50 opacity-75">
                    ...
                    <svg baseprofile="tiny" fill="green" height="824" stroke="white" stroke-linecap="round"
                        ...
                        <g id="features">
                            ...
                            <a href="{{ route('contents.regions', 3) }}">
                                <path
                            ...
                            {{-- Al-Qassim --}}
                            <a href="{{ route('contents.regions', 4) }}">
                                <path
                            ...
                            {{-- Alsharqia --}}
                            <a href="{{ route('contents.regions', 5) }}">
                                <path
                            ...
                            {{-- Asir --}}
                            <a href="{{ route('contents.regions', 6) }}">
                                <path
                            ...
                            {{-- Tabuk --}}
                            <a href="{{ route('contents.regions', 7) }}">
                                <path
                            ...
                            {{-- Hail --}}
                            <a href="{{ route('contents.regions', 8) }}">
                                <path
                            ...
                            {{-- Alhudud Alshamalia --}}
                            <a href="{{ route('contents.regions', 9) }}">
                                <path
                            ...
                            {{-- Jazan --}}
                            <a href="{{ route('contents.regions', 10) }}">
                                <path
                            ...
                            {{-- Najran --}}
                            <a href="{{ route('contents.regions', 11) }}">
                                <path
                            ...
                            {{-- Al-Baha --}}
                            <a href="{{ route('contents.regions', 12) }}">
                                <path
                            ...
                            {{-- Aljawf --}}
                            <a href="{{ route('contents.regions', 13) }}">
                                <path
