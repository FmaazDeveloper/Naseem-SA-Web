                    ...
                    <svg baseprofile="tiny" fill="green" height="824" stroke="white" stroke-linecap="round"
                        ...
                        <g id="features">
                            ...
                            <path
                                ...
                                id="9" name="Al Hudud ash Shamaliyah">
                            </path>
                            {{-- Jazan --}}
                            <path
                        ...
                        <g id="label_points">
                            ...
                            {{-- AL Madinah AL Munawwarah --}}
                            <circle class="Al Madinah" cx="239.7" cy="399" id="3">
                            </circle>
                            {{-- Al-Qassim --}}
                            <circle class="Al Quassim" cx="417.5" cy="340.8" id="4">
                            </circle>
                            {{-- Alsharqia --}}
                            <circle class="Ash Sharqiyah" cx="733.3" cy="548.4" id="5">
                            </circle>
                            {{-- Asir --}}
                            <circle class="`Asir" cx="410.2" cy="656.7" id="6">
                            </circle>
                            {{-- Tabuk --}}
                            <circle class="Tabuk" cx="143" cy="245.9" id="7">
                            </circle>
                            {{-- Hail --}}
                            <circle class="Ha'il" cx="347.2" cy="268.7" id="8">
                            </circle>
                            {{-- Alhudud Alshamalia --}}
                            <circle class="Al Hudud ash Shamaliyah" cx="397.2" cy="166.1" id="9">
                            </circle>
                            {{-- Jazan --}}
                            <circle class="Jizan" cx="399.7" cy="745" id="10">
                            </circle>
                            {{-- Najran --}}
                            <circle class="Najran" cx="531.3" cy="699.4" id="11">
                            </circle>
                            {{-- Al-Baha --}}
                            <circle class="Al Bahah" cx="342.6" cy="615.2" id="12">
                            </circle>
                            {{-- Aljawf --}}
                            <circle class="Al Jawf" cx="227.6" cy="166.7" id="13">
                            </circle>
